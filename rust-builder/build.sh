...
docker image tag ghcr.io/outoforder/rust-builder:latest outoforder/rust-builder:rocky8-$DATE
docker image tag ghcr.io/outoforder/rust-builder:latest outoforder/rust-builder:rocky8-$RUSTC_VERSION
docker image tag ghcr.io/outoforder/rust-builder:latest outoforder/rust-builder:latest
